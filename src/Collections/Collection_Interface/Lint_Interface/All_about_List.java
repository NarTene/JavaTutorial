package Collections.Collection_Interface.Lint_Interface;
...
public class All_about_List {
    public static void main(String[] args) {
        ...
        System.out.println("Add another list in main list " + ((ArrayList) list_Strings).addAll(list_OfSumColor));
